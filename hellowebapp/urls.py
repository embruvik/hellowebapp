...
urlpatterns = [
    ...
    url(r'^a[0-9]a*', views.index2, name='home2'),
    ...
    url(r'^accoutns/password/reset/(?P<uidb64>[0-9A-Za-z]+)-(?P<token>.+)/$', password_reset_confirm, {'template_name': 'registration_reset_confirm.html'}, name="password_reset_confirm"),
